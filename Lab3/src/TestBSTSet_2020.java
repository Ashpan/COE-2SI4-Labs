public class TestBSTSet_2020 {
    public static void main(String[] args) {
        ...
        System.out.println("The height d1 is " + a1.height()); //bonus: 4 for this case
        a1 = new BSTSet(d6);
        System.out.println("The size of d6 is " + a1.size());
        System.out.println("The height of d6 is " + a1.height()); //bonus: 4 for this case
        a1 = new BSTSet(d6);
        ...
        System.out.println("The height of d6 is " + a1.height()); //bonus: 4 for this case
        a2 = new BSTSet(d7);
        System.out.println("The height of d7 is " + a2.height()); //bonus: 4 for this case
        a3 = a1.union(a2);
        a4 = a1.intersection(a2);
        System.out.println("Print union:");
        a3.printBSTSet();
        System.out.println("The height of the union is " + a3.height()); //bonus: 5 for this case
        System.out.println("Print intersection:");
        a4.printBSTSet();
        System.out.println("The height of the intersection is " + a4.height()); //bonus: 3 for this case
