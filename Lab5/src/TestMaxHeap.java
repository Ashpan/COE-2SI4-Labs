...
public class TestMaxHeap {   
    ...
    public static void test(){	
        ...
        for(int loc=1;loc<sizes.length;loc++){
            ...
            System.out.println("UNSORTED:\t" + Arrays.toString(someArray1));

            MaxHeap.heapsort(someArray1);
            Arrays.sort(someArray2, Collections.reverseOrder());
            System.out.println("HEAP:\t" + Arrays.toString(someArray1));
            System.out.println("SORTED:\t" + Arrays.toString(someArray2));
